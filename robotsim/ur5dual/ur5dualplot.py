...
def genUr5dualmnp(ur5dual, handpkg, jawwidthrgt = None, jawwidthlft = None):
    """
...
def genUr5dualmnp_nm(ur5dual, handpkg, jawwidthrgt = None, jawwidthlft = None):
    """
    generate a panda3d nodepath for the ur5dual
    mnp indicates this function generates a mesh nodepath
    ...
    return genUr5dualmnp(ur5dual, handpkg, jawwidthrgt, jawwidthlft)